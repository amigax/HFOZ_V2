...
namespace ProjectDawn.Navigation.Hybrid
{
    ...
    public class CrowdGroupAuthoring : EntityBehaviour
    {
        ...
        //GAZ TRYING TO FIX POSITION
        public Transform Spawner;   // 👈 allowed here, because this is authoring
    ...
    internal class CrowdGroupBaker : Baker<CrowdGroupAuthoring>
    {
        public override void Bake(CrowdGroupAuthoring authoring)
        {
            ...
            AddComponent(entity, new CrowdGroup
            {
                ...
                ////GAZ FIX START POS
                //// 👇 bake spawner position into ECS
                //SpawnPosition = authoring.Spawner != null
                //? (float3)authoring.Spawner.position
                //: float3.zero
